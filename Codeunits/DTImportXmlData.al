codeunit 50145 "XML Data"
{
    ...
    var
        ...
        i: Integer;
    begin
        if UploadIntoStream(CaptionClassTranslate('Por favor seleccione un XML'), '', '', FileName, InS) then
            if XmlDocument.ReadFrom(InS, XmlDoc) then begin
                ...
                foreach Node in Records do begin
                    ...
                    // Data.Validate(Nombre, GetText(e, 'FirstName'));
